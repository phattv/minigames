...
const BASE_WORD_PAIRS = [
  ...
  ["Huấn luyện viên", "PT"],
  ["Barista", "Sommelier"],
  ["Hướng dẫn viên", "Lễ tân"],
  ["Data analyst", "Data scientist"],
  ["Product manager", "Project manager"],
  ["UX designer", "UI designer"],
  ["DevOps", "SRE"],
  ["Tài xế", "Thuyền trưởng"],
  ["Cứu hỏa", "Cứu hộ"],
  ["Nông dân", "Ngư dân"],
  ["Thợ may", "Thợ thêu"],
  ["Thợ mộc", "Thợ xây"],
  ...
  ["Mixologist", "Bartender chuyên nghiệp"],
  // household & home
  ["Sofa", "Ghế bành"],
  ["Bàn ăn", "Bàn cafe"],
  ...
  ["Bình lọc nước", "Máy lọc nước"],
  ["Bàn ủi", "Máy hấp quần áo"],
  ["Máy hút bụi", "Robot lau nhà"],
  ["Khóa thông minh", "Camera an ninh"],
  ["Bể cá", "Chậu cây"],
  ["Bình hoa", "Nến thơm"],
  ["Gối", "Chăn bông"],
  ["Bồn tắm", "Vòi sen"],
  ...
  ["Hố đen", "Sao neutron"],
  ["Thiên hà", "Tinh vân"],
  ["Thiên thạch", "Sao chổi"],
  ["SpaceX", "NASA"],
  ["Kính viễn vọng", "Đài thiên văn"],
  ["Nguyên tử", "Phân tử"],
  ["DNA", "RNA"],
  ["Tiến hóa", "Di truyền"],
  ["Big Bang", "Vũ trụ song song"],
  ["Nhiệt hạch", "Phân hạch"],
  ["CRISPR", "Gene therapy"],
  ...
  ["Xe Limousine", "Xe SUV"],
  ["Xe pickup", "Xe Van"],
  ["Xe thể thao", "Xe sedan"],
  ["Scooter", "Moped"],
  ["Thuyền", "Canoe"],
  ["Du thuyền", "Tàu sân bay"],
  ["Khinh khí cầu", "Trực thăng"],
  ["Xe đẩy", "Xe lăn"],
  ["Hoverboard", "Xe điện cân bằng"],
  ...
  ["Quan họ", "Cải lương"],
  ["Chèo", "Tuồng"],
  ["Đờn ca tài tử", "Nhã nhạc"],
  ["Tranh Đông Hồ", "Tranh lụa"],
  ["Gốm Bát Tràng", "Gốm Bình Dương"],
  ["Chùa", "Đình làng"],
  ["Phong thủy", "Tử vi"],
  ["Đông y", "Tây y"],
  ...
  ["Khăn tắm", "Khăn mặt"],
  ["Gương phòng tắm", "Gương soi"],
  ["Chìa khóa", "Thẻ từ"],
  ["Ví", "Túi đeo thắt lưng"],
  ["Dây sạc", "Cáp USB"],
  ["Bóng đèn", "Đèn LED"],
  ["Ổ điện", "Công tắc"],
  ["Băng keo", "Keo dán"],
  ...
  ["Đan", "Móc len"],
  ["Nhiều ảnh", "Quay phim"],
  ["Làm vườn", "Trồng bonsai"],
  ["Sưu tầm tem", "Sưu tầm coin"],
  ["Lego", "Rubik"],
  ["Sudoku", "Crossword"],
  ["Đọc sách", "Nghe audiobook"],
  ["Cosplay", "Roleplay"],
  ...
  ["Nhảy dây", "Nhảy lò cò"],
  ["Bi", "Con quay"],
  ["Thả diều", "Bắn súng nước"],
  ["Bút màu", "Màu nước"],
  ["Đất nặn", "Đất sét trẻ em"],
  ["Puzzle", "Jigsaw"],
  ["Búp bê", "Siêu nhân"],
  ["Xe đồ chơi", "Tàu hỏa đồ chơi"],
  ["Truyện tranh", "Truyện chữ"],
  ["Bong bóng", "Bong bóng xà phòng"],
  ["Cầu trượt", "Xích đu"],
  // more food
  ["Phở gà", "Phở bò"],
  ["Bánh mì chay", "Bánh mì thịt"],
  ["Lẩu cá", "Lẩu hải sản"],
  ["Bún đậu", "Bún chả"],
  ["Cháo tôm", "Cháo ếch"],
  ["Cơm chiên Dương Châu", "Cơm chiên Thái"],
  ["Gà hấp gừng", "Gà kho gừng"],
  ["Tôm rang muối", "Tôm chiên bột"],
  ["Cá kho tộ", "Cá nục kho"],
  ["Sườn xào chua ngọt", "Sườn ram mặn"],
  ["Đậu hũ chiên", "Đậu hũ non"],
  ["Bánh canh", "Bánh đa trộn"],
  ["Mì Quảng", "Mì hoành thánh"],
  ["Cháo cá", "Cháo đồ biển"],
  ["Sinh tố bơ", "Sinh tố xoài"],
  ["Nước chanh", "Nước cam ép"],
  ["Sữa tươi", "Sữa chua uống"],
  ["Cà phê trứng", "Cà phê muối"],
  ["Trà hoa cúc", "Trà cam thảo"],
  ["Kem dừa", "Kem matcha"],
  // more tech
