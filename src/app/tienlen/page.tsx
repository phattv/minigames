...
const CHART_COLORS = ["#3b82f6", "#f97316", "#22c55e", "#ef4444", "#a855f7", "#ec4899"];
const SEED_ROWS = 10;
  ...
  return (
    <main className="min-h-screen p-4">
              ...
              <div className="px-2 pt-1 pb-2">
                <svg viewBox={`0 0 ${W} ${H}`} className="w-full" style={{ height: 130 }}>
                  ...
                  {yTicks.map((v) => (
                    <g key={v}>
                      <line
                        ...
                        stroke="currentColor" strokeOpacity={v === 0 ? 0.2 : 0.08}
                        strokeWidth={1} strokeDasharray={v === 0 ? "4 3" : "2 4"}
                      />
                      <text
                  ...
                  {series.map((data, ci) => {
                    ...
                    const label = players[ci].length > 8 ? players[ci].slice(0, 7) + "…" : players[ci];
                    return (
                      <g key={ci}>
                        <polyline
                        ...
                        <text x={lx + 7} y={ly - 3} fontSize={8} fill={color} fontWeight="500">
                          {label}
                        </text>
                        <text x={lx + 7} y={ly + 8} fontSize={9} fill={color} fontWeight="700">
                          {last > 0 ? `+${last}` : last}
                        </text>
                      </g>
                    );
      ...
      <div className="mt-3 flex gap-2 flex-wrap">
        ...
        >
          {copyFeedback ? "Đã copy!" : "📋 Export Slack"}
        </Button>
        <Button
          variant="outline"
